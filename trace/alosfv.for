...
C     HPMUF HAS ADDED CORRECTION ALREADY
  ...
  205 CONTINUE
      ...
      END
C--------------------------------
      SUBROUTINE trace_alosfv(K)
C     propcore instrumentation: dumps the ionogram tables for area K
C     when PROPCORE_TRACE names a directory.
     ...
     2HTR(50,3), FNSQ(50,3)
      ...
      open(89,file=tdir(1:ltdir)//'/ionogram.txt',position='append')
      write(89,'(A,E18.9,I4)') 'ION ',GMT,K
      write(89,'(5E18.9)') (FVERT(IH,K),IH=1,30)
      write(89,'(5E18.9)') (HPRIM(IH,K),IH=1,30)
      write(89,'(5E18.9)') (HTRUE(IH,K),IH=1,30)
      write(89,'(5E18.9)') (AFAC(IH,K),IH=1,30)
      close(89)
      RETURN
      END
C------
