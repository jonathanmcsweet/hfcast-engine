...
C     when PROPCORE_TRACE names a directory.
     ...
     2HTR(50,3), FNSQ(50,3)
      ...
      write(87,'(5E18.9)') DSL,ASM,DSU,AGLAT,ACAV,FEAV,AFE,BFE,HNU,
     A HTLOSS,XNUZ,XVE,ADJ,SU,SL,ADS,SUS,SLS
      write(87,'(5E18.9)') (ABIY(K),K=1,KFX)
      write(87,'(5E18.9)') (ARTIC(K),K=1,KFX)
      close(87)
      RETURN
      END
C--------------------------------
