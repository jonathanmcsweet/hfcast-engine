...
C     PROPCORE_TRACE names a directory.
     ...
     B ,ISKP(3),IMODE(45,3),AFFLX(45,3),DELPEN(3,5),GML(45,3),FHP(45,3)
      ...
      write(85,'(A,I4,I8,I4,I4)') 'RFX ',NINT(GMT),KHZ,K,NROWS
      do 10 ia=1,NROWS
      write(85,'(5E18.9)') DELFX(ia,K),HPFLX(ia,K),HTFLX(ia,K),
     A GDFLX(ia,K),FVFLX(ia,K),AFFLX(ia,K),FLOAT(IMODE(ia,K))
   10 continue
      write(85,'(5E18.9)') DSKPKM(K),DMAXKM(K)
      if(NROWS.gt.0) then
        write(85,'(5E18.9)') DELSKP(K),HPSKP(K),HTSKP(K),FVSKP(K),
     A  FLOAT(ISKP(K))
      endif
      write(85,'(5E18.9)') (DELPEN(ia,K),ia=1,3)
      close(85)
      RETURN
      END
C--------------------------------
