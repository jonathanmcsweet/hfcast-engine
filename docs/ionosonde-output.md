...
| essn+storm               |  -0.028 |  0.581 |  1.069 | 13884 |
| climatology, quiet       |  -0.401 |  0.669 |  1.066 | 10878 |
| irtam, quiet             |  -0.064 |  0.327 |  0.666 | 10878 |
| essn, quiet              |  -0.018 |  0.551 |  0.989 | 10878 |
| essn+storm, quiet        |  -0.022 |  0.553 |  0.988 | 10878 |
| climatology, storm       |  +0.421 |  0.888 |  1.376 |  3006 |
| irtam, storm             |  +0.038 |  0.406 |  0.787 |  3006 |
| essn, storm              |  +0.066 |  0.763 |  1.323 |  3006 |
| essn+storm, storm        |  -0.056 |  0.727 |  1.322 |  3006 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.794, essn +0.390, essn+storm +0.403, 13864 day pairs
...
|  300k | essn+st+dud  |  -0.136 |  0.671 |  1.214 |            91.5% |
...
|  600k | essn+st+dud  |  -0.334 |  0.906 |  1.614 |            93.7% |
...
| essn+storm, quiet        |  +0.021 |  0.396 |  0.743 | 13475 |
| climatology, storm       |  +0.364 |  0.554 |  0.832 |   587 |
| irtam, storm             |  -0.018 |  0.292 |  0.600 |   587 |
| essn, storm              |  -0.029 |  0.467 |  0.814 |   587 |
| essn+storm, storm        |  -0.089 |  0.434 |  0.814 |   587 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.493, essn +0.147, essn+storm +0.151, 14075 day pairs
...
|  300k | essn+st+dud  |  -0.217 |  0.483 |  0.923 |            90.6% |
...
| essn+storm               |  -0.006 |  0.546 |  0.920 | 15463 |
| climatology, quiet       |  +0.073 |  0.543 |  0.928 | 15463 |
| irtam, quiet             |  +0.032 |  0.300 |  0.547 | 15463 |
| essn, quiet              |  -0.007 |  0.545 |  0.920 | 15463 |
| essn+storm, quiet        |  -0.006 |  0.546 |  0.920 | 15463 |
| climatology, storm       |       - |      - |      - |     0 |
| irtam, storm             |       - |      - |      - |     0 |
| essn, storm              |       - |      - |      - |     0 |
| essn+storm, storm        |       - |      - |      - |     0 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.572, essn +0.108, essn+storm +0.109, 15463 day pairs
...
|    0k | essn+st+dud  |  -0.006 |  0.546 |  0.920 |            92.3% |
...
|  600k | essn+st+dud  |  -0.228 |  0.850 |  1.393 |            87.9% |
...
| essn+storm               |  -0.020 |  0.506 |  0.853 | 11621 |
| climatology, quiet       |  +0.445 |  0.625 |  1.023 |  9806 |
| irtam, quiet             |  -0.069 |  0.352 |  0.682 |  9806 |
| essn, quiet              |  -0.004 |  0.494 |  0.828 |  9806 |
| essn+storm, quiet        |  -0.010 |  0.493 |  0.828 |  9806 |
| climatology, storm       |  +1.105 |  1.164 |  1.548 |  1798 |
| irtam, storm             |  -0.028 |  0.388 |  0.867 |  1798 |
| essn, storm              |  +0.028 |  0.602 |  0.990 |  1798 |
| essn+storm, storm        |  -0.082 |  0.581 |  0.977 |  1798 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.730, essn +0.462, essn+storm +0.474, 11621 day pairs
...
|  600k | essn+st+dud  |  -0.658 |  0.910 |  1.469 |            91.6% |
...
| essn+storm               |  +0.011 |  0.615 |  0.940 |  9519 |
| climatology, quiet       |  +0.846 |  0.955 |  1.468 |  9142 |
| irtam, quiet             |  -0.047 |  0.390 |  0.633 |  9142 |
| essn, quiet              |  +0.004 |  0.616 |  0.939 |  9142 |
| essn+storm, quiet        |  +0.007 |  0.616 |  0.939 |  9142 |
| climatology, storm       |  +1.067 |  1.124 |  1.415 |   377 |
| irtam, storm             |  +0.004 |  0.448 |  0.766 |   377 |
| essn, storm              |  +0.038 |  0.646 |  0.994 |   377 |
| essn+storm, storm        |  +0.044 |  0.598 |  0.976 |   377 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.757, essn +0.428, essn+storm +0.430, 9515 day pairs
...
|  600k | essn+st+dud  |  -0.583 |  1.045 |  1.641 |            93.0% |
...
| essn+storm               |  -0.036 |  0.620 |  1.067 |  9720 |
| climatology, quiet       |  +0.244 |  0.625 |  1.070 |  7490 |
| irtam, quiet             |  -0.145 |  0.382 |  0.632 |  7490 |
| essn, quiet              |  -0.013 |  0.572 |  0.972 |  7490 |
| essn+storm, quiet        |  -0.027 |  0.574 |  0.973 |  7490 |
| climatology, storm       |  +0.812 |  0.989 |  1.568 |  2230 |
| irtam, storm             |  -0.036 |  0.498 |  0.873 |  2230 |
| essn, storm              |  +0.082 |  0.813 |  1.328 |  2230 |
| essn+storm, storm        |  -0.080 |  0.831 |  1.336 |  2230 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.795, essn +0.404, essn+storm +0.416, 9695 day pairs
...
|  600k | essn+st+dud  |  -0.629 |  1.088 |  1.756 |            94.1% |
...
| essn+storm               |  -0.053 |  0.555 |  1.159 | 10126 |
...
| essn+storm, storm        |  -0.120 |  0.692 |  1.544 |  2682 |

day-to-day: climatology +0.000 (guard: must be +0.000), irtam +0.745, essn +0.164, essn+storm +0.214, 10126 day pairs
...
|    0k | essn+st+dud  |  -0.053 |  0.555 |  1.159 |            90.8% |
...
|    0k | essn+st+dud  |  -0.052 |  0.507 |  0.878 |            92.8% |
...
|  300k | essn+st+dud  |  -0.236 |  0.551 |  0.984 |            91.6% |
...
|  600k | essn+st+dud  |  -0.624 |  0.816 |  1.399 |            91.1% |
